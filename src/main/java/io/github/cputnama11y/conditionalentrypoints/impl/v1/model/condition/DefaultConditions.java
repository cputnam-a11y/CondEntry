...
import io.github.cputnama11y.conditionalentrypoints.impl.v1.model.condition.builtin.*;
...
public final class DefaultConditions {
    ...
    public static void bootstrap(SimpleRegistry<MapCodec<? extends Condition>> registry) {
        ...
        registry.register(id("all_mods_loaded"), AllModsLoaded.CODEC);
        registry.register(id("any_mods_loaded"), AnyModsLoaded.CODEC);
        registry.register(id("or"), AnyOfCondition.CODEC);
        registry.register(id("and"), AllOfCondition.CODEC);
        registry.register(id("not"), InvertCondition.CODEC);
    }
    ...
    public static boolean modsLoaded(List<String> mods, boolean and) {
    ...
    public static boolean conditionsMet(List<Condition> conditions, Condition.Context context, boolean and) {
